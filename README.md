...
<img src="https://media.giphy.com/media/UUsOy6IWmzw6mmeOpQ/giphy.gif" width="100%" height="10%" />
...
## Models
This section is about the models created by group 7 for the work of detecting COVID-19 in x-ray images. All notebooks with their respective model follow the pipeline exposed in the [standard notebook](models/).
